...
const KNOWLEDGE_GRAPH_DATA = {
    ...
    nodes: [
        // 核心根节点
        { id: '0', name: '大学生创新创业PBL项目制图谱', category: 0, symbolSize: 45, value: '通用高校 18学时高效实战示范课' },
        ...
        { id: 'L7', name: '第7课：合伙人协议与股权治理', category: 6, symbolSize: 34, value: '第7阶段：三角色互补团队融合与股权动态成熟' },
        ...
        { id: '42', name: '种子客群24h零成本触达路径', category: 3, symbolSize: 22, value: 'PBL实战：设计小范围社群零成本快速触达种子的渠道方案' },
        // 课时 5
        ...
        { id: '92', name: '黄金电梯路演与模拟答辩演练', category: 8, symbolSize: 22, value: 'PBL实战：现场三分钟快速演讲展示，模拟评委提问防御' }
    ],
    links: [
        // 核心树干 (根节点连向9大课时)
        { source: '0', target: 'L1' },
