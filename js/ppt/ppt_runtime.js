  ...
  ready(function () {
    ...
    if (!overview) {
      ...
      slides.forEach((s, i) => {
        ...
        overlay.style.background = 'linear-gradient(to bottom, rgba(0,0,0,0.2) 0%, transparent 40%, transparent 60%, rgba(0,0,0,0.8) 完整)';
    ...
    function go(n, fromRemote){
      ...
      if (numEl) { numEl.textContent = 'Slide ' + (n+1) + ' / ' + total; }
