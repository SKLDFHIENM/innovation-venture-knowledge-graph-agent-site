...
(function() {
    ...
    const qaList = [
        ...
        {
            id: 14, catId: 'cat-1',
            question: "如何判断一个双创项目是否具备‘精品课程’学术深度？",
        ...
        {
            id: 72, catId: 'cat-4',
            question: "如何在 BMC 中体现项目的‘社会价值’与双创精品课程要求？",
        ...
        },
        {
            ...
            answer: "‘构建 (Build) -> 衡量 (Measure) -> 学习 (Learn)’。通过高效构建 MVP 投放到市场，获取数据，从而决定坚持还是转型 (Pivot)。"
        },
        {
            id: 75, catId: 'cat-5',
        ...
        },
        {
            ...
            answer: "将创业项目与课程大纲（如双创精品课程、毕业设计）深度结合，实现‘以赛促学、以项目代考核’。"
        },
        {
            id: 108, catId: 'cat-6',
