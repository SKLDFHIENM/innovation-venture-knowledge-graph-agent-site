...
const BASE_EXAM_QUESTIONS = [
    ...
    },
    {
        ...
        question: '针对创业项目，"跨学科三角色互补团队"的最优团队组合是？',
    ...
    },
    {
        ...
        answer: 1,
        analysis: '缺乏 CAC、客单价与转化率支撑的暴利预测被称为“未经调研的主观推测财务”，会彻底丧失评委信任。'
    },
    {
    ...
    },
    {
        ...
        question: '商业计划书“鱼型十模块”中，鱼头部分代表的是？',
    ...
    },
    {
        ...
        answer: 2,
        analysis: '“红旅赛道”精神是服务基层：接地气+数字赋能+量化增收数据是红旅优秀奖标准。'
    },
    {
...
const ABILITY_RADAR_CONFIG = {
    ...
    levelMap: [
        ...
        { min: 71, max: 90, label: '成熟期双创人 🚀', advice: '综合能力出色，可高阶大赛获奖对标！建议立即申请入驻本校双创园！' }
    ]
};
                ...
                <div style="display:flex; flex-direction:column; height:100%; overflow-y:auto; padding-right:8px;">
                    ...
                    <div style="display:flex; flex-direction:column; gap:10px; margin-bottom:16px;">
                        ${q.options.map((opt, idx) => {
                            ...
                            if (selectedOpt === idx) {
                                optStyle += " background:linear-gradient(135deg, rgba(0,242,254,0.15) 0%, rgba(37,99,235,0.2) 完整); border-color:#00f2fe; font-weight:700;";
                            } else {
