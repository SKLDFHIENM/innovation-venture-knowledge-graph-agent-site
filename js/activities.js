...
(function(window) {
    ...
    window.ACTIVITIES_DATA = [
        ...
        },
        {
            ...
            category: 'feasibility',
            categoryName: '市场可行',
            title: '盈亏平衡点 (BEP) 临界销量高效测算',
            time: '10分钟',
            pblNode: '#42 财务保本测算',
            badge: '📈 BEP 临界测算',
            desc: '输入固定成本、变动成本与单价，高效计算项目保本销售量与月保本额。',
        ...
        // ── 模块 5：产品原型与精益验证 ──
        {
            ...
            pblNode: '#51 MVP原型与实验',
            badge: '🧪 假门冒烟测试',
            desc: '用中低无码化 Landing Page 或海报进行假门实验，低成本验证用户真实意向。',
        ...
        // ── 模块 6：双创大赛与路演答辩 ──
        {
            ...
            pblNode: '#61 答辩高压防御',
            badge: '⚔️ 60s 评委防御',
            desc: '模拟“互联网+”创新创业大赛专家提出 5 大尖锐质问，限时 60 秒简洁精准反驳。',
            rules: '1. 抽取评委刁难问题（如技术外包、市场太小）；2. 60秒内完成逻辑自洽防御；3. 评委打分。',
            workflows: {
                teacher: '扮演创新创业大赛资深专家连环追问 ➔ 计时叫停废话 ➔ 教授高情商与专业答辩技巧',
        ...
        },
        {
            ...
            workflows: {
                teacher: '发布创新创业大赛网评淘汰率 10 大原因 ➔ 指导自查表比对 ➔ 严查假数据与夸大表述',
        ...
        },
        {
            ...
            badge: '🎬 10页路演 Deck',
            desc: '拆解优秀项目标准 10 页 Pitch Deck 逻辑链（痛点-方案-市场-产品-模式-壁垒-团队-财务）。',
            rules: '1. 匹配 10 页 Deck 逻辑骨架；2. 检查单页字数与视觉重点；3. 生成标准 Pitch 纲要。',
            workflows: {
                teacher: '展示创新创业大赛优秀项目 10 页 Deck 原件 ➔ 讲解一页一主旨原则 ➔ 指导视觉美化',
