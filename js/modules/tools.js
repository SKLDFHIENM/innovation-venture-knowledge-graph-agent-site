...
(function() {
    ...
    const ToolsModule = {
        ...
        exportStudentJSON() {
            ...
            downloadAnchor.setAttribute("download", `双创精品课程_学情档案_${new Date().toISOString().slice(0, 10)}.json`);
        ...
        openStudentReportModal() {
            ...
            const ALL_NODES = [
                ...
                { id: '31', name: '3.1 精益 BMC（商业模式画布） 画布九要素' }, { id: '32', name: '3.2 MVP（最小可行产品） 高效原型构建' }, { id: '33', name: '3.3 用户 WTP（付费意愿） 意愿测试' }, { id: '34', name: '3.4 产品三层次五步迭代' },
                { id: '41', name: '4.1 核心创始团队分工与测评' }, { id: '42', name: '4.2 股权与控制权生命线' }, { id: '43', name: '4.3 Vesting（股权分期成熟机制） 动态成熟协议' },
                { id: '51', name: '5.1 商业计划书要素化结构设计大纲拼装' }, { id: '52', name: '5.2 路演 12 页与资本退出' }, { id: '53', name: '5.3 路演质询深度应答与核心团队防御应对' }, { id: '54', name: '5.4 创业园免租与补贴申报' }
            ];
                ...
                <div class="report-paper-container" style="background:#0f172a; border:1px solid rgba(0,194,224,0.3); border-radius:16px; width:90%; max-width:850px; max-height:90vh; overflow-y:auto; padding:30px; box-sizing:border-box; color:#e2e8f0; position:relative; box-shadow:0 20px 50px rgba(0,0,0,0.8);">
                    ...
                    <div id="print-area">
                        ...
                        <div style="text-align:center; border-bottom:2px solid #00c2e0; padding-bottom:15px; margin-bottom:20px;">
                            <h2 style="margin:0 0 6px; font-size:22px; color:#fff; letter-spacing:1px;">《大学生创新创业基础》PBL精品课程 · 学情诊断评估报告</h2>
                            <p style="margin:0; font-size:12px; color:#94a3b8;">教育部“人工智能+”双创精品课程系统生成 · 生成时间：${new Date().toLocaleString()}</p>
                        </div>
