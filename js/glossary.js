...
const GLOSSARY_DATA = [
    ...
    },
    {
        ...
        example: '签署《知识产权归属协议》，规定技术合伙人编写的代码 完整 属于公司资产。'
    },
    {
        id: 'cie_competition',
        name: '中国大学生创新大赛',
    ...
    },
    {
        ...
        en: 'Agentic Workflow',
        cat: 'AI硬科技',
        desc: '结合大语言模型自主规划、工具调用与多Agent协作的自动化解决复杂问题的工作流模式。',
        application: '支撑创业团队自动化进行市场调研、数据分析与代码生成，实现人机协同高效运营。',
        example: '利用 AI 导师智能体协同进行双创痛点挖掘与商业模式画布自动校验。'
    }
];
