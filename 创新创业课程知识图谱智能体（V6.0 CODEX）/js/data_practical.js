...
const GRAPH_DATA_PRACTICAL = {
    ...
    nodes: [
        ...
        { id: '61', name: '系统原型交互设计构建', category: 2, symbolSize: 28, value: '使用低代码或AI工具极速开发符合演示规范的原型' },
        ...
        { id: 'p5', name: '计划书编制与辩证答辩表达力', category: 5, symbolSize: 38, value: '能力维度五：金奖BP框架四层次拼装、路演演说技巧与质疑攻防辩驳力', fixed: true, x: 510, y: 460 },
