...
(function() {
    ...
    const PresentationModule = {
        ...
        /**
         * 全套 18 学时 PBL 金课大屏放映目录索引 (提供一键全景检索)
         */
        pblIndexList: [
            ...
            { id: '22', title: '💻 放映：第三次课 创业者特质与生涯规划技能拼图', hours: '2学时', tag: 'Hacker/Hipster/Hustler铁三角' },
            { id: '31', title: '💻 放映：第四次课 精益商业模式画布 (BMC) 9要素设计', hours: '2学时', tag: '奥斯特瓦德画布解构' },
            { id: '33', title: '💻 放映：第五次课 24 小时零代码 MVP 原型构建', hours: '2学时', tag: '极速原型与冷启动测试' },
            { id: '34', title: '💻 放映：第六次课 AIGC 零代码原型与 iCAN 软硬件指南', hours: '2学时', tag: '数据飞轮与算法落地' },
            { id: '42', title: '💻 放映：第七次课 合伙人铁三角与股权动态 Vesting 机制', hours: '2学时', tag: '67%控制权与退场契约' },
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px; border-bottom:1px solid rgba(255,255,255,0.1); padding-bottom:15px;">
                        <div>
                            <h2 style="margin:0; font-size:20px; font-weight:900; color:#ffffff; display:flex; align-items:center; gap:10px;">
                                <i class="fas fa-desktop" style="color:#f59e0b;"></i> 💻 全套 18 学时 PBL 金课大屏演播快捷放映中心
                            </h2>
