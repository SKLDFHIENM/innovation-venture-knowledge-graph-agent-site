...
- <strong>16-24h 冷启动测试</strong>：推给 20 位种子用户试用，收集吐槽与真金白银的反馈数据！`
    ...
    {
        keywords: ['铁三角', '组队', '股权', 'Vesting', '成熟机制', '控制权'],
        question: '合伙人“铁三角”如何配置？如何设计动态 Vesting 股权成熟协议？',
        reply: `🎯 <strong>导师解答：铁三角组队与动态 Vesting 股权治理</strong><br/><br/>
📚 <strong>课程理论支撑：</strong>
- <strong>铁三角配置：</strong> Hacker (技术硬核) + Hipster (产品设计/体验) + Hustler (商务运营/路演)。
...
- <strong>Vesting 协议：</strong> 标准为“4 年分期成熟 + 1 年崖山期 (Cliff)”。离职未满 1 年者，未成熟股权由公司/期权池以 1 元名义无偿收回！`
    },
    {
        ...
        reply: `🎯 <strong>导师解答：12 页黄金路演 BP 与答辩防御话术</strong><br/><br/>
...
3. <strong>团队维度 (铁三角)</strong>：考核 Hacker+Hipster+Hustler 跨学科配置，以及控制权红线与 Vesting 动态股权。
...
2. **回答结构规范**（使用 Markdown 格式）：
   ...
   - 📚 **课程理论支撑**：融合 Sarasvathy 效果推理、SCAMPER 奔驰法、JTBD 待办任务、Belbin 铁三角、Vesting 股权分期、邓立治 BP 鱼型十模块、OBE 成果导向等学术概念。
...
2. <strong>团队匹配：</strong> 组建 Hacker + Hipster + Hustler 铁三角，锁定 CEO 绝对控制权。<br/>
